                            ...
                            @foreach ($clientes as $cliente)
                                                            ...
                                                            <div class="row list-group-item-action m-0">
                                                                ...
                                                                <div class="col">
                                                                    <form action="{{ route('item.destroy', $item->id) }}" method="post">
                                                                        @csrf
                                                                        @method('DELETE')
                                                                        <button type="submit" class="btn btn-sm text-aqua" data-bs-toggle-tooltip="tooltip" data-bs-placement="top" title="Editar Item">
                                ...
                                <tr class="item">
                                    ...
                                    <td class="d-flex justify-content-around">
                                        <a href="{{ route('cliente.show', $cliente->id) }}" class="btn text-aqua"  data-bs-toggle-tooltip="tooltip" data-bs-placement="top" title="Vizualizar Cliente">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-archive" viewBox="0 0 16 16">
                                                <path d="M0 2a1 1 0 0 1 1-1h14a1 1 0 0 1 1 1v2a1 1 0 0 1-1 1v7.5a2.5 2.5 0 0 1-2.5 2.5h-9A2.5 2.5 0 0 1 1 12.5V5a1 1 0 0 1-1-1V2zm2 3v7.5A1.5 1.5 0 0 0 3.5 14h9a1.5 1.5 0 0 0 1.5-1.5V5H2zm13-3H1v2h14V2zM5 7.5a.5.5 0 0 1 .5-.5h5a.5.5 0 0 1 0 1h-5a.5.5 0 0 1-.5-.5z"/>
                                            </svg>
                                        </a>
                                        <!-- Button trigger modal -->
                                        <button type="button" class="btn text-aqua p-0" data-bs-toggle-tooltip="tooltip" data-bs-placement="top" title="Vizualizar Itens" data-bs-toggle="modal" data-bs-target="#Modal_{{ $cliente->id }}">
                                        ...
                                        <!-- Button trigger modal -->
                                        <button type="button" class="btn text-aqua p-0" data-bs-toggle-tooltip="tooltip" data-bs-placement="top" title="Editar Cliente" data-bs-toggle="modal" data-bs-target="#Modal_edit_{{ $cliente->id }}">
                                        ...
                                        <form action="{{ route('cliente.destroy', $cliente->id) }}" method="post">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" class="btn text-aqua p-0" data-bs-toggle-tooltip="tooltip" data-bs-placement="top" title="Excluir Cliente">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">
                                                    <path d="M5.5 5.5A.5.5 0 0 1 6 6v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5zm2.5 0a.5.5 0 0 1 .5.5v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5zm3 .5a.5.5 0 0 0-1 0v6a.5.5 0 0 0 1 0V6z"/>
                                                    <path fill-rule="evenodd" d="M14.5 3a1 1 0 0 1-1 1H13v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V4h-.5a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1H6a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1h3.5a1 1 0 0 1 1 1v1zM4.118 4 4 4.059V13a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1V4.059L11.882 4H4.118zM2.5 3V2h11v1h-11z"/>
                                                </svg>
